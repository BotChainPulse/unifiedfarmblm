...
const products = [
  ...
  { name: 'Brooded Chicks (1 Month)', desc: 'One-month-old chicks raised under optimal conditions in our brooder houses. Strong, healthy, and ready to grow into productive layers or broilers.', price: 'UGX 12,000', unit: 'each', image: '/images/product-brooded.jpg' },
